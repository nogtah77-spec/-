...
export const AD_TEMPLATES: Record<AdTemplateKey, AdTemplate> = {
  ...
  premium_desktop: {
    ...
    width: 1800, height: 230,
    ratio: "180:23",
    breakpoint: "desktop",
    bleed: 20, safeInset: 20,
    zones: [
      { x: 1450, y: 11,  w: 330, h: 52,  label: "Logo",  color: "rgba(147,51,234,0.18)", strokeColor: "#9333ea" },
      { x: 50,   y: 32,  w: 1180,h: 149, label: "Title", color: "rgba(59,130,246,0.12)", strokeColor: "#3b82f6" },
      { x: 1510, y: 170, w: 270, h: 49,  label: "CTA",   color: "rgba(34,197,94,0.18)",  strokeColor: "#22c55e" },
    ],
  },
  ...
  premium_mobile: {
    ...
    ratio: "120:23",
    breakpoint: "mobile",
    bleed: 15, safeInset: 16,
    zones: [
      { x: 870,  y: 11,  w: 315, h: 49,  label: "Logo",  color: "rgba(147,51,234,0.18)", strokeColor: "#9333ea" },
      { x: 40,   y: 34,  w: 820, h: 147, label: "Title", color: "rgba(59,130,246,0.12)", strokeColor: "#3b82f6" },
      { x: 870,  y: 170, w: 315, h: 49,  label: "CTA",   color: "rgba(34,197,94,0.18)",  strokeColor: "#22c55e" },
    ],
  },
  ...
  secondary_desktop: {
    ...
    ratio: "96:23",
    breakpoint: "desktop",
    bleed: 15, safeInset: 15,
    zones: [
      { x: 660, y: 11,  w: 285, h: 54,  label: "Logo",  color: "rgba(147,51,234,0.18)", strokeColor: "#9333ea" },
      { x: 40,  y: 38,  w: 600, h: 142, label: "Title", color: "rgba(59,130,246,0.12)", strokeColor: "#3b82f6" },
      { x: 660, y: 165, w: 285, h: 54,  label: "CTA",   color: "rgba(34,197,94,0.18)",  strokeColor: "#22c55e" },
    ],
  },
  ...
  secondary_mobile: {
    ...
    bleed: 15, safeInset: 15,
    zones: [
      { x: 505, y: 9,   w: 280, h: 46,  label: "Logo",  color: "rgba(147,51,234,0.18)", strokeColor: "#9333ea" },
      { x: 40,  y: 43,  w: 715, h: 133, label: "Title", color: "rgba(59,130,246,0.12)", strokeColor: "#3b82f6" },
      { x: 505, y: 175, w: 280, h: 46,  label: "CTA",   color: "rgba(34,197,94,0.18)",  strokeColor: "#22c55e" },
    ],
  },
};
