...
export const AD_TEMPLATES: Record<AdTemplateKey, AdTemplate> = {
  ...
  premium_desktop: {
    ...
    ratio: "9:2",
    breakpoint: "desktop",
    bleed: 20, safeInset: 30,
    zones: [
      { x: 1450, y: 20,  w: 330, h: 90,  label: "Logo",  color: "rgba(147,51,234,0.18)", strokeColor: "#9333ea" },
      { x: 50,   y: 55,  w: 1180,h: 260, label: "Title", color: "rgba(59,130,246,0.12)", strokeColor: "#3b82f6" },
      { x: 1510, y: 295, w: 270, h: 85,  label: "CTA",   color: "rgba(34,197,94,0.18)",  strokeColor: "#22c55e" },
    ],
  },
  ...
  premium_mobile: {
    ...
    ratio: "3:1",
    breakpoint: "mobile",
    bleed: 15, safeInset: 25,
    zones: [
      { x: 870,  y: 20,  w: 315, h: 85,  label: "Logo",  color: "rgba(147,51,234,0.18)", strokeColor: "#9333ea" },
      { x: 40,   y: 60,  w: 820, h: 255, label: "Title", color: "rgba(59,130,246,0.12)", strokeColor: "#3b82f6" },
      { x: 870,  y: 295, w: 315, h: 85,  label: "CTA",   color: "rgba(34,197,94,0.18)",  strokeColor: "#22c55e" },
    ],
  },
  ...
  secondary_desktop: {
    ...
    zones: [
      { x: 660, y: 15,  w: 285, h: 70,  label: "Logo",  color: "rgba(147,51,234,0.18)", strokeColor: "#9333ea" },
      { x: 40,  y: 50,  w: 600, h: 185, label: "Title", color: "rgba(59,130,246,0.12)", strokeColor: "#3b82f6" },
      { x: 660, y: 215, w: 285, h: 70,  label: "CTA",   color: "rgba(34,197,94,0.18)",  strokeColor: "#22c55e" },
    ],
  },
  ...
  secondary_mobile: {
    ...
    bleed: 15, safeInset: 20,
    zones: [
      { x: 505, y: 15,  w: 280, h: 80,  label: "Logo",  color: "rgba(147,51,234,0.18)", strokeColor: "#9333ea" },
      { x: 40,  y: 75,  w: 715, h: 230, label: "Title", color: "rgba(59,130,246,0.12)", strokeColor: "#3b82f6" },
      { x: 505, y: 305, w: 280, h: 80,  label: "CTA",   color: "rgba(34,197,94,0.18)",  strokeColor: "#22c55e" },
    ],
  },
};
