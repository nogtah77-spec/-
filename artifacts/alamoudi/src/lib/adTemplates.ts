...
export const AD_TEMPLATES: Record<AdTemplateKey, AdTemplate> = {
  ...
  premium_desktop: {
    ...
    width: 1800, height: 138,
    ratio: "300:23",
    breakpoint: "desktop",
    bleed: 12, safeInset: 12,
    zones: [
      { x: 1450, y: 7,   w: 330, h: 31,  label: "Logo",  color: "rgba(147,51,234,0.18)", strokeColor: "#9333ea" },
      { x: 50,   y: 19,  w: 1180,h: 89,  label: "Title", color: "rgba(59,130,246,0.12)", strokeColor: "#3b82f6" },
      { x: 1510, y: 102, w: 270, h: 29,  label: "CTA",   color: "rgba(34,197,94,0.18)",  strokeColor: "#22c55e" },
    ],
  },
  ...
  premium_mobile: {
    ...
    zones: [
      { x: 870,  y: 10,  w: 315, h: 38,  label: "Logo",  color: "rgba(147,51,234,0.18)", strokeColor: "#9333ea" },
      { x: 40,   y: 27,  w: 820, h: 118, label: "Title", color: "rgba(59,130,246,0.12)", strokeColor: "#3b82f6" },
      { x: 870,  y: 137, w: 315, h: 38,  label: "CTA",   color: "rgba(34,197,94,0.18)",  strokeColor: "#22c55e" },
    ],
  },
