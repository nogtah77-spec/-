...
export const AD_TEMPLATES: Record<AdTemplateKey, AdTemplate> = {
  ...
  premium_desktop: {
    ...
    width: 1800, height: 290,
    ratio: "180:29",
    breakpoint: "desktop",
    bleed: 20, safeInset: 25,
    zones: [
      { x: 1450, y: 14,  w: 330, h: 65,  label: "Logo",  color: "rgba(147,51,234,0.18)", strokeColor: "#9333ea" },
      { x: 50,   y: 40,  w: 1180,h: 188, label: "Title", color: "rgba(59,130,246,0.12)", strokeColor: "#3b82f6" },
      { x: 1510, y: 214, w: 270, h: 62,  label: "CTA",   color: "rgba(34,197,94,0.18)",  strokeColor: "#22c55e" },
    ],
  },
  ...
  premium_mobile: {
    ...
    ratio: "120:29",
    breakpoint: "mobile",
    bleed: 15, safeInset: 20,
    zones: [
      { x: 870,  y: 14,  w: 315, h: 62,  label: "Logo",  color: "rgba(147,51,234,0.18)", strokeColor: "#9333ea" },
      { x: 40,   y: 43,  w: 820, h: 185, label: "Title", color: "rgba(59,130,246,0.12)", strokeColor: "#3b82f6" },
      { x: 870,  y: 214, w: 315, h: 62,  label: "CTA",   color: "rgba(34,197,94,0.18)",  strokeColor: "#22c55e" },
    ],
  },
  ...
  secondary_desktop: {
    ...
    ratio: "96:29",
    breakpoint: "desktop",
    bleed: 15, safeInset: 18,
    zones: [
      { x: 660, y: 14,  w: 285, h: 68,  label: "Logo",  color: "rgba(147,51,234,0.18)", strokeColor: "#9333ea" },
      { x: 40,  y: 48,  w: 600, h: 179, label: "Title", color: "rgba(59,130,246,0.12)", strokeColor: "#3b82f6" },
      { x: 660, y: 208, w: 285, h: 68,  label: "CTA",   color: "rgba(34,197,94,0.18)",  strokeColor: "#22c55e" },
    ],
  },
  ...
  secondary_mobile: {
    ...
    bleed: 15, safeInset: 18,
    zones: [
      { x: 505, y: 11,  w: 280, h: 58,  label: "Logo",  color: "rgba(147,51,234,0.18)", strokeColor: "#9333ea" },
      { x: 40,  y: 54,  w: 715, h: 167, label: "Title", color: "rgba(59,130,246,0.12)", strokeColor: "#3b82f6" },
      { x: 505, y: 221, w: 280, h: 58,  label: "CTA",   color: "rgba(34,197,94,0.18)",  strokeColor: "#22c55e" },
    ],
  },
};
