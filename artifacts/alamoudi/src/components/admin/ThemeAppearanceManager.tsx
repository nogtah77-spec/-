    ...
    try {
      ...
      toast({
        ...
        description: themeId === "charcoal" 
          ? "تم تطبيق ثيم الفحم والبرونز والتركواز العصري."
    ...
    <div className="space-y-4 max-w-3xl">
      ...
      <div className="flex items-center justify-between gap-3 p-3 rounded-xl bg-card border border-border/70 shadow-2xs">
        ...
        <Badge variant="outline" className="px-2.5 py-0.5 bg-accent/10 border-accent/30 text-accent text-[11px] font-bold shrink-0">
          {currentActiveTheme === "charcoal" ? "الفحم والبرونز نشط" : "الملكي الكلاسيكي نشط"}
        </Badge>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div 
          className={`p-3.5 rounded-xl border-2 transition-all duration-200 cursor-pointer relative bg-card ${
            currentActiveTheme === "charcoal"
              ? "border-[#D97706] shadow-sm ring-1 ring-[#D97706]/30" 
        ...
        >
          <div className="flex items-start justify-between gap-2 mb-2">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-md bg-[#181C20] border border-[#D97706]/50 flex items-center justify-center text-[#D97706] shrink-0">
                <Palette className="h-3.5 w-3.5" />
              </div>
              <div>
                <h4 className="text-xs font-bold text-foreground leading-tight">ثيم الفحم والبرونز العصري</h4>
                <span className="text-[10px] text-muted-foreground font-mono">Dark Charcoal & Bronze</span>
              </div>
            </div>

            {currentActiveTheme === "charcoal" ? (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-[#D97706] text-white text-[10px] font-bold shrink-0">
          ...
          <p className="text-[11px] text-muted-foreground leading-snug mb-3">
            رمادي فحمي هادئ (#181C20)، لوحة فحمية زجاجية (#22272D)، زر تركوازي (#0F766E)، ونحاسي (#D97706).
          </p>
          ...
          <div className="flex items-center justify-between gap-1 pt-2 border-t border-border/50">
            <div className="flex items-center gap-1.5">
              ...
              <span className="w-4 h-4 rounded-full bg-[#D97706] border border-white/20 shadow-2xs" title="برونز #D97706" />
            </div>
            ...
            <Button
              ...
              className="h-7 px-3 rounded-lg bg-[#D97706] hover:bg-[#B45309] text-white font-bold text-[11px]"
            >
      ...
      <div className="p-3 rounded-xl bg-card border border-border/70 space-y-2 shadow-2xs">
        <div className="flex items-center justify-between text-xs">
          ...
          <span className="text-[11px] text-muted-foreground">
            {currentActiveTheme === "charcoal" ? "ثيم الفحم العصري" : "الثيم الملكي الكلاسيكي"}
          </span>
        </div>
        ...
        {currentActiveTheme === "charcoal" ? (
          ...
          <div className="p-2.5 rounded-lg bg-[#181C20] border border-[#333C46] flex flex-col sm:flex-row items-center justify-between gap-2.5">
            <div className="flex items-center gap-2">
              <div className="px-2.5 py-1 rounded-md bg-[#D97706] text-white text-[10px] font-bold shadow-2xs flex items-center gap-1">
